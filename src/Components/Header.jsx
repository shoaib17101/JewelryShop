...
export default function Header() {
    ...
    const Menu=(
         <div className="off-canvas w-full md:hidden ">
                  <ul className="list-none  gap-5 uppercase text-[15px] lg:flex flex-col  ">
    ...
    return (
        <>
            <nav className="navbar navbar-lg bg-transparent shadow-md  flex  justify-between lg:justify-around p-3 h-[90px]">
                ...
                <div className=""> <h1 className='text-4xl lg:hidden' onClick={()=>{open?setopen(false):setopen(true) }}>&#8801;</h1></div>
