    ...
    <>
      <section className="bg-[url(https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/hero.jpg)] bg-center bg-cover lg:h-[773px] h-[550px] flex flex-col md:items-center " id={Style.sec}>
        <div className="flex flex-col gap-5 h-full p-2 justify-center w-9/12 lg:gap-8 ">
          ...
          <button className="btn btn-outline btn-lg uppercase w-[150px]">Shop Now</button>
        </div>
      </section>
      <section className='py-[50px] md:flex flex-col items-center'>
        ...
        <div className="grid grid-cols-2 p-3 gap-3 md:grid-cols-4 gap-y-10  md:items-center md:w-full lg:w-[80%] mt-10 ">
          <div className="card bg-base-100 w-[100%] shadow-sm bg-[url(https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/earrings-06-b-600x750.jpg)] bg-cover bg-center order-2  h-[220px] md:h-[400px] hover:bg-left">
